        ...
        <header>
            <div className='flex flex-col md:flex-row items-center p-5 bg-gray-500/10 rounded-b-2xl'>
                ...
                <div className='flex items-center space-x-5 flex-1 justify-end'>
                    ...
                    <Avatar name="ilya misyura" round size='50' color='#0055d1'/>
                </div>
            </div>

            <div className='flex items-center justify-center px-5 md:py-5 py-2'>
                <p className='flex items-center text-sm font-light pr-5 shadow-xl rounded-xl w-fit bg-white italic max-w-3x text-[#0055D1] p-5'>
