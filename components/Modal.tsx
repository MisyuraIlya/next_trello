            ...
            <Dialog.Panel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
              ...
              <div className='mt-2'>
                <input 
                  ...
                  className='w-full border border-gray-300 rounedd-md outline-none p-5'
                />
              </div> 
              <TaskTypeRadioGroup/>
              ...
              <div className='mt-2'>
                ...
                <button type='button' onClick={() => { imagePickerRef.current?.click()}} className='w-full border border-gray-300 rounded-md outline-none p-5 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2'>
                  <PhotoIcon className='h-6 w-5 mr-2 inline-block' />
                  Upload Image
                </button>
                {image && 
                  <Image src={URL.createObjectURL(image)} alt='upload image' width={200} height={200} className='w-full h-44 object-cover mt-2 filter hover:grayscale transition-all duration-150 cursor-not-allowed' onClick={() => setImage(null)}  />
                }
              ...
              <div className='mt-2'>
                ...
                text-blue-900 hover:bg-blue-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:bg-gray-100
